  ...
  return (
    <nav className="w-[253px] h-[363px] flex flex-col gap-y-6 ">
      <div className="flex  gap-3">
        ...
        />
        <p className="font-medium text-[20px]">{user?.fullName}</p>
      </div>
      <div className="w-full flex justify-between">
        ...
        <button
          onClick={LogOut}
          className="text-[#797979] font-normal text-[16px]"
        >
          Logout
        </button>
      </div>
      <ul className="text-[20px] text-gray-500">
        <li className="flex gap-x-4 p-2 cursor-pointer hover:bg-[#DDDDDD] rounded-lg">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
